...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection {
    PPImage *img = [PPImage imageWithCmSampleBuffer:sampleBuffer];
    img.cameraFrame = YES;
    img.orientation = PPProcessingOrientationLeft;
    [self.coordinator processImage:img];
    
}

- (void)coordinatorWithError:(NSError**)error {
    ...
    settings.uiSettings.autorotateOverlay = YES;
