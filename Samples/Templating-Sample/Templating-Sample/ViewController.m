...
- (void)scanningViewController:(UIViewController<PPScanningViewController> *)scanningViewController
    ...
    for (PPRecognizerResult* result in results) {
        ...
        if ([result isKindOfClass:[PPBlinkOcrRecognizerResult class]]) {
            ...
            title = [ocrResult parsedResultForName:ID_SEX parserGroup:ID_SEX_CITIZENSHIP_DOB];
                        title = [ocrResult parsedResultForName:ID_CITIZENSHIP parserGroup:ID_SEX_CITIZENSHIP_DOB];
                        title = [ocrResult parsedResultForName:ID_DATE_OF_BIRTH parserGroup:ID_SEX_CITIZENSHIP_DOB];
                        title = [ocrResult parsedResultForName:ID_FIRST_NAME parserGroup:ID_FIRST_NAME];
            message = [ocrResult description];
        }
    };
